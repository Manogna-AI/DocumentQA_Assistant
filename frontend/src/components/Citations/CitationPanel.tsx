...
export default function CitationPanel() {
  ...
  return (
    <aside className="hidden min-h-0 flex-col overflow-hidden border-l border-slate-200/80 bg-slate-50/80 dark:border-slate-800/80 dark:bg-slate-900/50 xl:flex">
