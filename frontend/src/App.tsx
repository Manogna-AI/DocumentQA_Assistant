...
export default function App() {
  ...
  return (
    <div className="h-dvh overflow-hidden bg-slate-100 text-slate-950 dark:bg-slate-950 dark:text-slate-100">
      ...
      <div className="relative mx-auto flex h-full max-w-[1600px] flex-col p-3 sm:p-4 lg:p-6">
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[2rem] border border-white/70 bg-white/80 shadow-2xl shadow-slate-200/80 backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/70 dark:shadow-black/30">
          <Header />
          <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden lg:grid-cols-[300px_minmax(0,1fr)] lg:grid-rows-1 xl:grid-cols-[320px_minmax(0,1fr)_360px]">
            <DocumentPanel />
            <ChatPanel />
            <CitationPanel />
          </div>
